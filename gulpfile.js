...
/**
 * Copies required Phaser-input files from the './node_modules/phaser-input' folder into the './build/scripts' folder.
 * This way you can call 'npm update', get the lastest Phaser input version and use it on your project with ease.
 */
function copyPhaserInput() {

    var srcList = ['phaser-input.js'];

    srcList = srcList.map(function(file) {
        return PHASER_INPUT_PATH + file;
    });
...
gulp.task('watch-static', ['copyPhaser, copyPhaserInput'], browserSync.reload);
